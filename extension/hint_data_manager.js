...
const DIRECTIVES_FILES = [
	`${__dirname}/../hint_data/directives.json`,
	`${__dirname}/../hint_data/lua/directives.json`,
];
const VARIABLES_FILES = [
	`${__dirname}/../hint_data/variables.json`,
	`${__dirname}/../hint_data/lua/variables.json`,
];
